...
.e-css.e-btn.e-active {
  ...
  -webkit-box-shadow: none;
          box-shadow: none;
  color: var(--color-sf-secondary-text-color-pressed);
  background: var(--color-sf-secondary-bg-color-selected) !important; /* stylelint-disable-line declaration-no-important */
  border-color: var(--color-sf-secondary-border-color-selected) !important; /* stylelint-disable-line declaration-no-important */
  color: var(--color-sf-secondary-text-color-selected) !important; /* stylelint-disable-line declaration-no-important */
}

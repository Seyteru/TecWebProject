...
.e-grid .e-res-toolbar .e-toolbar-items:not(.sf-grid).e-search-wrapper .e-search-icon {
  padding: 10px;
}
.e-grid .e-res-toolbar .e-toolbar-items .e-responsive-right .e-search-wrapper {
  padding-left: 0;
...
.e-grid:not(.e-grid-min-height) .e-gridcontent .e-gridcontent tr.e-row .e-rowcell:empty {
  height: 36px;
}
...
.e-grid.e-bothlines td.e-rowcell.e-cellselectionbackground, .e-grid.e-bothlines.e-rtl td.e-rowcell.e-cellselectionbackground, .e-grid.e-rtl td.e-rowcell.e-cellselectionbackground {
  border: 1px solid rgba(var(--color-sf-on-surface));
}
.e-grid:not(.e-row-responsive) .e-gridcontent tr.e-row:first-child td.e-cellselectionbackground {
  padding-top: 7px;
...
.e-grid .e-gridpopup .e-content,
.e-grid .e-filterbarcell,
.e-grid .e-filterbarcelldisabled, .e-grid.e-default .e-grouptopleftcell,
.e-grid .e-headercell,
.e-grid .e-summarycell,
.e-grid .e-detailheadercell,
...
.e-bigger .e-grid.e-bothlines.e-rtl td.e-rowcell.e-cellselectionbackground, .e-grid.e-bothlines.e-bigger.e-rtl td.e-rowcell.e-cellselectionbackground, .e-bigger .e-grid.e-rtl td.e-rowcell.e-cellselectionbackground, .e-grid.e-bigger.e-rtl td.e-rowcell.e-cellselectionbackground {
  border: 1px solid rgba(var(--color-sf-on-surface));
}

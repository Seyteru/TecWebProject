...
.e-colorpicker-container .e-icon-btn:hover {
  background-color: #5c636a !important; /* stylelint-disable-line declaration-no-important */
  color: #fff;
}
...
.smart-textarea-suggestion-overlay {
  background-color: #fff;
  color: #212529;
  -webkit-box-shadow: 0 1.25px 4px 0 rgba(0, 0, 0, 0.176);
          box-shadow: 0 1.25px 4px 0 rgba(0, 0, 0, 0.176);
}

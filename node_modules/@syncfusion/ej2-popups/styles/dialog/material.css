...
.e-footer-content .e-btn.e-primary:not([DISABLED]):focus-visible,
.e-footer-content .e-btn.e-primary:not([DISABLED]):focus {
  background: rgba(227, 22, 91, 0.2);
}
.e-footer-content .e-btn.e-primary:not([DISABLED]):hover {
  background: rgba(227, 22, 91, 0.1);
}
.e-footer-content .e-btn.e-primary:not([DISABLED]):active {
  background: rgba(227, 22, 91, 0.3);
}
.e-footer-content .e-btn:not([DISABLED]):focus-visible,
.e-footer-content .e-btn:not(.e-primary):not([DISABLED]):focus,
.e-footer-content .e-btn:not([DISABLED]):hover {
  background: #e0e0e0;
}
